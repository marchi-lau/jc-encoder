(function( $ ){
	...
	var settings = {
		...
		'showMeter'	: 'false',	// show/hide meter button
		...
		loadVideo: function( options ) {
			return this.each(function() {
				...
				if (ios) {
					...
					video_content = "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' id='HDExamplePlayer' width='" + s.width + "' height='" + s.height + "' codebase='http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab'> <param name='movie' value='http://localhost:3000/HKJCPlayer.swf?src=" + videourl + "&math=" + rnd + "&volume=" + s.volume + "&volumeControl=" + s.volumeControl + "&loop=" + s.loop + "&autostart=" + s.autostart + "&bgcolors=" + s.bgcolors + "&showMeter=" + s.showMeter + "&streamQuality=" + s.quality + "&qualityBtn=" + s.qualityBtn + "&language=" + s.language + "' /> <param name='quality' value='high' /> <param name='bgcolor' value='#111111' /> <param name='allowScriptAccess' value='sameDomain' /> <param name='allowFullScreen' value='true' /> <embed src='http://localhost:3000/HKJCPlayer.swf?src=" + videourl + "&math=" + rnd + "&volume=" + s.volume + "&volumeControl=" + s.volumeControl + "&loop=" + s.loop + "&autostart=" + s.autostart + "&bgcolors=" + s.bgcolors + "&showMeter=" + s.showMeter + "&streamQuality=" + s.quality + "&qualityBtn=" + s.qualityBtn + "&language=" + s.language + "' quality='high' bgcolor='#111111' width='" + s.width + "' height='" + s.height + "' name='HDExamplePlayer' align='middle' play='true' loop='false' quality='high' allowScriptAccess='sameDomain' allowFullScreen='true' type='application/x-shockwave-flash' pluginspage='http://www.adobe.com/go/getflashplayer'> </embed> </object>";
				}
